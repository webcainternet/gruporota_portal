...
$taxa_boleto = 0;
$data_venc = "08/10/2015";//date("d/m/Y", time() + ($dias_de_prazo_para_pagamento * 86400));  // Prazo de X dias OU informe data: "13/04/2006"; 
...
$IdDoSeuSistemaAutoIncremento = '1413'; // Deve informar um numero sequencial a ser passada a função abaixo, Até 6 dígitos
$agencia = "4095"; // Num da agencia, sem digito
$conta = "15105"; // Num da conta, sem digito
$convenio = "15105"; //Numúmero do convênio indicado no frontend
...
$dadosboleto["numero_documento"] = "XXXX";	// Num do pedido ou do documento
