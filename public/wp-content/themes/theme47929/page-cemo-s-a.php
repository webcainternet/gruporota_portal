    ...
    <div style="float: left; margin-top: -20px;">
        ...
        <div style="text-align: justify; color: #333;">
            <div style="float: left; width: 195px; text-align: left;">
                <img src="/wp-content/uploads/logo-png/logo-cemo-g.png" style="margin-left: 10px; width: 150px; margin-top: 10px;">
            </div>
...
<div>
A CEMO S.A., atua para executar e construir obras e serviços tais como:
...
<div style=" padding-right: 15px;"><img src="/wp-content/themes/theme47929/images/icon-googlemaps.png"><span style="color: #AB9632; font-size: 14px; text-transform: uppercase;">Onde estamos: </span>Av. Frederic Engles 177, Polana Cimento - Maputo - Mocambique
</div>
</div>
