		...
		<header class="motopress-wrapper header">
			<div class="container">
				<div class="row" style="position: fixed;z-index: 999999999 !important;">
					<div class="<?php echo cherry_get_layout_class( 'full_width_content' ); ?>" data-motopress-wrapper-file="wrapper/wrapper-header.php" data-motopress-wrapper-type="header" data-motopress-id="<?php echo uniqid() ?>" style="  height: 115px; background-color:rgba(255, 255, 255, 0.9);">
						<div class="row" >
