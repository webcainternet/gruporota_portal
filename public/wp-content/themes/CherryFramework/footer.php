				...
				*/ ?>
					<div style="width: 1170px; margin-left: 30px;">
						...
						<div class="footer-spacing" style="width: 27%;">
							...
							<div style="text-align: right;"><img src="/wp-content/themes/theme47929/images/footer_trofeu.png" style="width: 40px; margin-top: 42px; margin-right: 82px;opacity: 0.5;filter: alpha(opacity=50);"></div>
						</div>
